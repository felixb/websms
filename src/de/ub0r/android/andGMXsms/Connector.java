...
public abstract class Connector extends AsyncTask<String, Boolean, Boolean> {
	...
	static final short ARCOR = SLOONO + 1; 
	...
	private static Connector getConnector(final Context con,
		...
		case SLOONO_PRO:
			...
			break;
		case ARCOR:
			c = new ConnectorArcor(WebSMS.prefsUserArcor, WebSMS.prefsPasswordArcor, connector);
			break;
		default:
	 ...
	 *             //TODO flx, this method does not return an HttpClientInstance. It should be executeRequest IMHO 
	 *             
	 */
