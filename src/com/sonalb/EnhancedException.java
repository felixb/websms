 ...
 * subclass of <code>Exception</code>.
 * <p>
...
public class EnhancedException extends Exception implements IEnhancedException {
	/**
	 * 
	 */
	 ...
	 *            the detail message.
	 */
	public EnhancedException(final String s) {
		super(s);
	}
	 ...
	 * @see java.lang.Exception
	 */
	public EnhancedException(final Exception under) {
		super();
		this.setCausalException(under);
	}

	/**
	 * Constructs an EnhancedException with the specified detail message and
	 * causal Exception.
	 * 
	 * @param under
	 *            the causal Exception.
	 ...
	 * @see java.lang.Exception
	 */
	public EnhancedException(final String s, final Exception under) {
		super(s);
		this.setCausalException(under);
	}

	/**
	 * Constructs an EnhancedException with a detail message, causal Exception,
	 * error code, class and method of origin. For example,<br>
	 * 
	 * <pre>
	 * ...
	...
	/**
	 * Constructs an EnhancedException with an error code and, class and method
	 * of origin. For example,<br>
	 * 
	 * <pre>
	 * ...
	 ...
	 *            the method of origin.
	 */
	public EnhancedException(final String code, final Object o,
			final String method) {
		super();
		this.setCode(code);
		this.setOriginClass(o);
	...
	/**
	 * Constructs an EnhancedException with a detail message, error code, class
	 * and method of origin. For example,<br>
	 * 
	 * <pre>
	 * ...
	 ...
	 * @see java.lang.Exception
	 */
	public EnhancedException(final String s, final String code, final Object o,
			final String method) {
		super(s);
		this.setCode(code);
		this.setOriginClass(o);
	 ...
	 * would be returned by <code>Exception.toString()</code>. Otherwise, the
