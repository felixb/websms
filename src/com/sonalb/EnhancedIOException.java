 ...
 * subclass of <code>java.io.IOException</code>.
 * <p>
...
public class EnhancedIOException extends java.io.IOException implements
		IEnhancedException {
	/**
	 * 
	 */
	 ...
	 *            the detail message.
	 */
	public EnhancedIOException(final String s) {
		super(s);
	}
	 ...
	 */
	public EnhancedIOException(final Exception under) {
		super();
		this.setCausalException(under);
	}

	/**
	 * Constructs an EnhancedIOException with the specified detail message and
	 * causal Exception.
	 * 
	 * @param under
	 *            the causal Exception.
	 ...
	 * @see java.lang.Exception
	 */
	public EnhancedIOException(final String s, final Exception under) {
		super(s);
		this.setCausalException(under);
	}

	/**
	 * Constructs an EnhancedIOException with a detail message, causal
	 * Exception, error code, class and method of origin. For example,<br>
	 * <code>
	 * ...<br>
	 * throw new EnhancedIOException("Failed to connect to server", excp, "SVR_0090", this, "connect");<br>
	 * ...</code>
	 * 
	 * @param under
	 *            the causal Exception.
	...
	/**
	 * Constructs an EnhancedIOException with an error code and, class and
	 * method of origin. For example,<br>
	 * <code>
	 * ...<br>
	 * throw new EnhancedIOException("SVR_0090", this, "connect");<br>
	 * ...</code>
	 * 
	 * @param code
	 *            the error-code.
	 ...
	 *            the method of origin.
	 */
	public EnhancedIOException(final String code, final Object o,
			final String method) {
		super();
		this.setCode(code);
		this.setOriginClass(o);
	...
	/**
	 * Constructs an EnhancedIOException with a detail message, error code,
	 * class and method of origin. For example,<br>
	 * <code>
	 * ...<br>
	 * throw new EnhancedIOException("Failed to connect to server", "SVR_0090", this, "connect");<br>
	 * ...</code>
	 * 
	 * @param under
	 *            the causal Exception.
	 ...
	 * @see java.lang.Exception
	 */
	public EnhancedIOException(final String s, final String code,
	 ...
	 * would be returned by <code>IOException.toString()</code>. Otherwise, the
	 * returned String is formed by concatenating the following :-<br>
	 * <ul>
	 ...
	 *         <code>EnhancedIOException</code>.
	 * @see java.io.IOException#toString()
	 */
	public String toString() {
		...
		sb.append(": ");
		sb.append((this.getLocalizedMessage() == null) ? "" : this
				.getLocalizedMessage());
		sb.append(" : Code=");
